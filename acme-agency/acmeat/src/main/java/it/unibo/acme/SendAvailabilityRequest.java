...
public class SendAvailabilityRequest implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        if (userOrder == null) {
            delegateExecution.setVariable(DELIVERY_COMPANIES_PROPOSAL, new DeliveryOrderList());
            return;
        }
        ...
        List<CompletableFuture<ClientResponse>> webResources = getCompletableFutures(order, companies, clientConfig);

        DeliveryOrderList deliveryCompanies = getAvailableDeliveryCompanies(webResources);
