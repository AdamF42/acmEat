 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "soseng.wsdl", wsdlLocation = "/myWsdl.wsdl")
    ...
    extends Service
{
    ...
    static {
        BANKSERVICE_WSDL_LOCATION = it.unibo.bpmn2jolie.generated.BankService.class.getResource("/myWsdl.wsdl");
